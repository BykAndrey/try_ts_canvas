...
function append(id) {
    SIZE++;
    points.push(new Point_1.default(ctx, id, config_1.WINDOW_WIDTH / 2 + Math.sin(10 * id) * (config_1.WINDOW_WIDTH / 5), config_1.WINDOW_HEIGHT / 2 + Math.cos(10 * id) * (config_1.WINDOW_HEIGHT / 2), (Math.random() + 1) * 3, (Math.random() + 1) * (Math.random() + 4)));
}
for (var i = 0; i < 15; i++) {
    append(i);
}
